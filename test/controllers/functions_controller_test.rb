...
class FunctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post functions_url, params: { function: { description: @function.description, salary: @function.salary, third: @function.third } }
    end
  ...
  test "should update function" do
    patch function_url(@function), params: { function: { description: @function.description, salary: @function.salary, third: @function.third } }
