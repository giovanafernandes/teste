...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { impracticable: @weather.impracticable, type: @weather.type } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { impracticable: @weather.impracticable, type: @weather.type } }
