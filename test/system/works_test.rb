...
class WorksTest < ApplicationSystemTestCase
  ...
  test "creating a Work" do
    ...
    fill_in "Company", with: @work.Company_id
    fill_in "User", with: @work.User_id
    fill_in "Budget", with: @work.budget
    fill_in "End", with: @work.end
    check "Isfinished" if @work.isFinished
    fill_in "Start", with: @work.start
